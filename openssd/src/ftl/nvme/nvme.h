...
#define ONE_GB                          (1024ULL * 1024 * 1024) /* 1GB */
// #define NVME_STORAGE                    68719476736ULL /* 64GB */
#define FLASH_STORAGE					FLASH_SIZE
#define NVME_STORAGE					SSD_SIZE
...
#define ADMIN_FS_STATUS										0x91
#define ADMIN_IO_TEST										0x92
#define ADMIN_SSD_CONFIG_ADMIN								0x93
// #define ADMIN_DATA_CHECK									0x93
// #define ADMIN_CS_STATUS										0x94
// add commands here
...
typedef struct _IO_READ_COMMAND_DW12
{
	union {
		...
		struct {
			unsigned short NLB;//zero-based value
			unsigned short IS_CS					:1;
			unsigned short IS_HOST_GCIO				:1;
			unsigned short GET_SSD_LOG				:1;
			// TODO: maybe find somewhere else with larger fields to store CS_SEQ_ID 
			unsigned short CS_SEQ_ID			    :5;
			unsigned short IS_CS_HEAD				:1;
