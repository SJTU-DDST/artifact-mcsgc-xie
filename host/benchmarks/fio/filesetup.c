...
int setup_files(struct thread_data *td)
{
	...
	if ((!total_size || total_size == -1ULL) && !o->size &&
		...
		printf("total_size=%llu, o->size=%llu, o->fill_device=%d, o->nr_files=%d, o->file_size_low=%llu, o->file_size_high=%llu\n",
			total_size, o->size, o->fill_device, o->nr_files, o->file_size_low, o->file_size_high);
