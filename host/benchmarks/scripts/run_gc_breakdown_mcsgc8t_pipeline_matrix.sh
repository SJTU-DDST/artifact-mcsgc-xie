...
configurations=(
    "mcsgc8t-pipeline bigfile 01-mcsgc8t-pipeline-bigfile"
    "mcsgc8t-pipeline smallfile 02-mcsgc8t-pipeline-smallfile"
)

echo "============================================================"
echo "mCSGC8t pipeline GC breakdown matrix"
echo "Batch directory: ${batch_dir}"
echo "Execution order: pipeline bigfile, pipeline smallfile"
echo "============================================================"
...
for entry in "${configurations[@]}"; do
    ...
    if GC_BREAKDOWN_RESULT_PATH_FILE="${result_path_file}" \
        ...
        # Keep a stable log name in the batch directory without duplicating it.
        ...
        echo "The remaining diagnostic run was not started." >&2
...
echo
echo "Both mCSGC8t pipeline GC breakdown diagnostics completed successfully."
echo "Batch directory: ${batch_dir}"
