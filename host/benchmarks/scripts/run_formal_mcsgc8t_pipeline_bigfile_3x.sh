...
if [ ! -r "${module_path}" ]; then
    die "formal Host module is unavailable; run './prepare_formal_host_module.sh mcsgc8t-pipeline' first"
fi

echo "============================================================"
echo "Formal optimized mCSGC8t pipeline single-big-file benchmark"
...
echo
echo "All three formal optimized mCSGC8t pipeline single-big-file runs completed successfully."
