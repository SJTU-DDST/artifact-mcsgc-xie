...
# Stress the terminal curseg rollover fix with the failure-prone varmail case.
...
export FILEBENCH_AB_WORKLOADS=filebench-varmail
export FILEBENCH_AB_REPETITIONS=3
...
export FILEBENCH_AB_SCHEDULE_MODE=configuration-major
