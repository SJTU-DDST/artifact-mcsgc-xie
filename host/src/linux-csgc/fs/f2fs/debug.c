...
static char *csgc_status_name = "csgc_status";
static unsigned int csgc_status;
...
static char *csgc_max_count_name = "csgc_max_count";
static unsigned long long csgc_max_count = -1;

void f2fs_set_csgc_max_count(unsigned long long count)
{
	csgc_max_count = count;
}

unsigned long long f2fs_get_csgc_max_count(void)
{
	return csgc_max_count;
}

static char *nr_cs_cores_name = "nr_cs_cores";
static unsigned int nr_cs_cores = 1;

void f2fs_set_nr_cs_cores(unsigned int nr_cores)
{
	nr_cs_cores = nr_cores;
}
...
static char *csgc_sync_name = "csgc_sync";
static unsigned int csgc_sync = 1;
...
void __init f2fs_create_root_stats(void)
{
	...
	debugfs_create_file("status", 0444, f2fs_debugfs_root, NULL,
			    &stat_fops);
	debugfs_create_u32(csgc_status_name, 0444, f2fs_debugfs_root, &csgc_status);
	debugfs_create_u64(csgc_max_count_name, 0644, f2fs_debugfs_root, &csgc_max_count);
	debugfs_create_u32(nr_cs_cores_name, 0644, f2fs_debugfs_root, &nr_cs_cores);
	debugfs_create_u32(csgc_sync_name, 0644, f2fs_debugfs_root, &csgc_sync);
#endif
}
