...
# <base path> is the path to the root of the kernel source tree
# e.g. 
# sudo bash ./scripts/decode_stacktrace.sh vmlinux $(pwd) < outputs/0310_trace1 > outputs/0310_trace1_out
