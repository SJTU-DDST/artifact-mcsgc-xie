...
enum {
	...
	NVME_RW_CSGC		= 1 << 0, // mark for CSGC command
	NVME_RW_GCIO_HOST = 1 << 1,   // mark for host GC IO stat
	// 1 << 2 is used for retrieving ssd log
	// 3 ~ 7 are for cs_seq_id
	NVME_RW_CS_IS_HEAD = 1 << 8,  // mark for head of a cs sequence
};
