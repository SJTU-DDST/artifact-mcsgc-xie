...
enum nvme_admin_opcode {
	...
	nvme_admin_raid_status		= 0x90,
	nvme_admin_fs_status		= 0x91,
	nvme_admin_io_test			= 0x92,
	nvme_admin_ssd_admin		= 0x93,
	nvme_admin_get_inode		= 0xa0,
	nvme_admin_dump_blk			= 0xa1,
	nvme_admin_gc_test			= 0xa2,
	nvme_admin_fill_storage		= 0xa3,
};
